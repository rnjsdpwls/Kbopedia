...
import { Container, ImagePosition, Pagebutton,PostBtnPosition, StyeldImages, StyledTable } from '../CommunityPage/StyledCommunity';
...
export default function Community() {
  ...
  useEffect(() => {
    // 데이터를 불러오는 부분
    axios.get('http://localhost:3001/all/wiz')
      .then((response) => {
